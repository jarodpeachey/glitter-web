...
const TalentCarouselSlide = ({ image, className, name }) => {
  ...
  return (
    <figure aria-labelledby="themes__title" className={`card carousel__slide ${className}`} id={name}>
      <svg viewBox="0 0 700 450" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <image width="100%" height="100%" preserveAspectRatio="xMinYMin slice" xlinkHref={image} clip-path={`url(#${clipPathID})`} loading="lazy" y="25" />
